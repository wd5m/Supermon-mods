<?php
        ...
        error_log($_SESSION['user'].' logout succeeded.');      // WD5M 20221107 - Log to Apache error.log
        syslog(LOG_INFO,$_SESSION['user'].' logout succeeded.');        // WD5M 20221107 - Log to Linux syslog
